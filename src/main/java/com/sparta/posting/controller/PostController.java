...
public class PostController {
    ...
    @PostMapping("/post")
    public PostResponseDto createPosting(@RequestBody PostRequestDto postRequestDto, @AuthenticationPrincipal UserDetailsImpl userDetails) throws HttpResponseDto { //Body 형태로 포스팅 정보를 받아오고 jwt도 같이 받아온다.
    ...
    public PostResponseDto getPostingsById(@PathVariable Long postId) throws HttpResponseDto {
        return postService.getPostingById(postId);
    }

    @PutMapping("/post/{postId}")
    public Object updatePosting(@PathVariable Long postId, @RequestBody PostRequestDto postRequestDto, @AuthenticationPrincipal UserDetailsImpl userDetails) throws HttpResponseDto {
        return postService.update(postId, postRequestDto,userDetails.getUser());
    }

    @DeleteMapping("/post/{postId}")
    public HttpResponseDto deletePosting(@PathVariable Long postId, @AuthenticationPrincipal UserDetailsImpl userDetails) throws HttpResponseDto {
